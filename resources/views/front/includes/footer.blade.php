...
<div>
    ...
    <div class="social-items-wrapper">
        <div class="social-items-menu">
            ...
            <div class="social-item">
                <a href="viber://chat?number=%2B{{$contact->viber}}" class="target_viber">
                    <div>
...
<a href="#logo-up" class="footer__button-up">
    <img src="{{asset('assets/front/svg/social/rounded_arrow.svg')}}" alt="">
</a>
